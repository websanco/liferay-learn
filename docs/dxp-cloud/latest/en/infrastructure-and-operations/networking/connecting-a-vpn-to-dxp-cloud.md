...
1. Scroll down to the VPN section of the page and click _Create New VPN_.
    ...
    ![Click Create New VPN from your environment's Settings page.](./connecting-a-vpn-to-dxp-cloud/images/01.png)
...
1. Select the connection protocol to use. Here are the supported protocols:
    ...
    * [IPSec](https://www.cloudflare.com/learning/network-layer/what-is-ipsec/)
    ...
    ![Select the protocol to use to connect to a VPN.](./connecting-a-vpn-to-dxp-cloud/images/02.png)
...
1. Enter one or more port forwarding routes for your VPN connection. Fill in the required fields for each route:
    ...
    * **Destination Port**: The port of the customer network interfacing with the VPN.
    ...
    ![Add one or more port forwarding routes before creating the VPN connection.](./connecting-a-vpn-to-dxp-cloud/images/03.png)
...
![The VPN details page displays the VPN status, configuration details, and VPN network activities.](./connecting-a-vpn-to-dxp-cloud/images/04.png)
...
![Click on the configured VPN connection to see the VPN details page.](./connecting-a-vpn-to-dxp-cloud/images/05.png)
...
![The top-right corner of the details page displays the connection status and gives the Connect or Disconnect options.](./connecting-a-vpn-to-dxp-cloud/images/06.png)
...
![The Disconnect VPN page asks you to confirm the impact of disconnecting before proceeding.](./connecting-a-vpn-to-dxp-cloud/images/07.png)
...
![Click the Edit button from the Actions menu when the VPN is not connected to change the configuration.](./connecting-a-vpn-to-dxp-cloud/images/08.png)

## Additional Information

* [Client-to-Site VPN](./client-to-site-vpn.md)
* [VPN Setup Example](./vpn-setup-example.md)