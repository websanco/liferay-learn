...
Document types are made of metadata fields and help users define the purpose of Document Library files. Document types also help users integrate files with other features like [search](../../../../using-search/getting-started/search-overview.md) and [workflow](../../../../process-automation/workflow/introduction-to-workflow.md).
