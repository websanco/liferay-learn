...
/**
 * Provides the local service interface for S5E6Entry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see S5E6EntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface S5E6EntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.acme.s5e6.service.impl.S5E6EntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the s5e6 entry local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link S5E6EntryLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public S5E6Entry addS5E6Entry(S5E6Entry s5e6Entry);
	...
	public S5E6Entry createS5E6Entry(long S5E6EntryId);
	...
	public S5E6Entry deleteS5E6Entry(long S5E6EntryId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public S5E6Entry deleteS5E6Entry(S5E6Entry s5e6Entry);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public S5E6Entry fetchS5E6Entry(long S5E6EntryId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public S5E6Entry fetchS5E6EntryByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<S5E6Entry> getS5E6Entries(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<S5E6Entry> getS5E6EntriesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public S5E6Entry getS5E6Entry(long S5E6EntryId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public S5E6Entry getS5E6EntryByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public S5E6Entry updateS5E6Entry(S5E6Entry s5e6Entry);
