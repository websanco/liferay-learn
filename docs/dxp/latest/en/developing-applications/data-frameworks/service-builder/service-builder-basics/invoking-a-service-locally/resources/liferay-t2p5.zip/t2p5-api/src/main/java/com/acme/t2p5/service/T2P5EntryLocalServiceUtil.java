...
/**
 * Provides the local service utility for T2P5Entry. This utility wraps
 * <code>com.acme.t2p5.service.impl.T2P5EntryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class T2P5EntryLocalServiceUtil {
	 ...
	 */
	public static T2P5Entry addT2P5Entry(T2P5Entry t2p5Entry) {
		return getService().addT2P5Entry(t2p5Entry);
	}
	 ...
	 */
	public static T2P5Entry createT2P5Entry(long t2p5EntryId) {
		return getService().createT2P5Entry(t2p5EntryId);
	}
	 ...
	 */
	public static T2P5Entry deleteT2P5Entry(long t2p5EntryId)
		throws PortalException {

		return getService().deleteT2P5Entry(t2p5EntryId);
	}
	 ...
	 * @return the t2p5 entry that was removed
	 */
	public static T2P5Entry deleteT2P5Entry(T2P5Entry t2p5Entry) {
		return getService().deleteT2P5Entry(t2p5Entry);
	}
	...
	public static T2P5Entry fetchT2P5Entry(long t2p5EntryId) {
		return getService().fetchT2P5Entry(t2p5EntryId);
	}
	 ...
	 */
	public static List<T2P5Entry> getT2P5Entries(int start, int end) {
		return getService().getT2P5Entries(start, end);
	}
	 ...
	 */
	public static int getT2P5EntriesCount() {
		return getService().getT2P5EntriesCount();
	}
	 ...
	 * @throws PortalException if a t2p5 entry with the primary key could not be found
	 */
	public static T2P5Entry getT2P5Entry(long t2p5EntryId)
		throws PortalException {

		return getService().getT2P5Entry(t2p5EntryId);
	}
	 ...
	 */
	public static T2P5Entry updateT2P5Entry(T2P5Entry t2p5Entry) {
		return getService().updateT2P5Entry(t2p5Entry);
	}

	public static T2P5EntryLocalService getService() {
		return _service;
	}

	private static volatile T2P5EntryLocalService _service;
