...
import com.acme.t2p5.model.EntryModel;
...
/**
 * The base model implementation for the Entry service. Represents a row in the &quot;T2P5_Entry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	 ...
	 */
	public static final String TABLE_NAME = "T2P5_Entry";
	...
	public static final String TABLE_SQL_CREATE =
		"create table T2P5_Entry (entryId LONG not null primary key,description VARCHAR(75) null,name VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table T2P5_Entry";

	public static final String ORDER_BY_JPQL = " ORDER BY entry.entryId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY T2P5_Entry.entryId ASC";
