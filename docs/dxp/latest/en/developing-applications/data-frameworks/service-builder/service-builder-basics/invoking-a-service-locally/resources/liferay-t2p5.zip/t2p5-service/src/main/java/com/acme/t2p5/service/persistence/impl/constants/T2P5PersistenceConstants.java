...
package com.acme.t2p5.service.persistence.impl.constants;
...
public class T2P5PersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "com.acme.t2p5.service";
