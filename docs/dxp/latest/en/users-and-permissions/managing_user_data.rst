...
- `Announcements <../collaboration-and-social/alerts_and_announcements.md>`
- `Blogs <../content-authoring-and-management/blogs.md>`
- `Bookmarks (deprecated) <../installation-and-upgrades/upgrading-liferay/reference/maintenance-mode-and-deprecations-in-7-3.md>`
- `Contacts Center <../collaboration-and-social/social-tools/user-guide/using-the-contacts-center-widget.md>`
- `Documents and Media <../content-authoring-and-management/documents_and_media.md>`
- `Forms <../process-automation/forms.md>`
- `Message Boards <../collaboration-and-social/message_boards.md>`
- `Web Content <../content-authoring-and-management/web_content.md>`
