...
.. toctree::
   ...
   devops/configuring-a-password-policy.md
   devops/adding-custom-fields-to-users.md
   devops/connecting_to_a_user_directory.rst

-  :doc:`/users-and-permissions/devops/configuring-a-password-policy`
