...
public class H6D2PersistenceImpl
	...
	private FinderPath _finderPathWithPaginationFindBytodo;
	private FinderPath _finderPathWithoutPaginationFindBytodo;
	private FinderPath _finderPathCountBytodo;

	/**
	 * Returns all the h6d2s where todo = &#63;.
	 *
	 * @param todo the todo
	 * @return the matching h6d2s
	 */
	@Override
	public List<H6D2> findBytodo(String todo) {
		return findBytodo(todo, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the h6d2s where todo = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>H6D2ModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<H6D2> findBytodo(String todo, int start, int end) {
		return findBytodo(todo, start, end, null);
	}

	/**
	 * Returns an ordered range of all the h6d2s where todo = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>H6D2ModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<H6D2> findBytodo(
		String todo, int start, int end,
		OrderByComparator<H6D2> orderByComparator) {

		return findBytodo(todo, start, end, orderByComparator, true);
	}
	...
	public List<H6D2> findBytodo(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindBytodo;
				finderArgs = new Object[] {todo};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBytodo;
			finderArgs = new Object[] {todo, start, end, orderByComparator};
		}
		...
		if (list == null) {
			...
			boolean bindTodo = false;

			if (todo.isEmpty()) {
				sb.append(_FINDER_COLUMN_TODO_TODO_3);
			}
			else {
				bindTodo = true;

				sb.append(_FINDER_COLUMN_TODO_TODO_2);
			}
	...
	/**
	 * Returns the first h6d2 in the ordered set where todo = &#63;.
	 *
	 * @param todo the todo
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching h6d2
	 ...
	 */
	@Override
	public H6D2 findBytodo_First(
			String todo, OrderByComparator<H6D2> orderByComparator)
		throws NoSuchH6D2Exception {

		H6D2 h6d2 = fetchBytodo_First(todo, orderByComparator);
	 ...
	 */
	@Override
	public H6D2 fetchBytodo_First(
		String todo, OrderByComparator<H6D2> orderByComparator) {

		List<H6D2> list = findBytodo(todo, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last h6d2 in the ordered set where todo = &#63;.
	 *
	 * @param todo the todo
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching h6d2
	 ...
	 */
	@Override
	public H6D2 findBytodo_Last(
			String todo, OrderByComparator<H6D2> orderByComparator)
		throws NoSuchH6D2Exception {

		H6D2 h6d2 = fetchBytodo_Last(todo, orderByComparator);
	 ...
	 */
	@Override
	public H6D2 fetchBytodo_Last(
		String todo, OrderByComparator<H6D2> orderByComparator) {

		int count = countBytodo(todo);

		if (count == 0) {
			return null;
		}

		List<H6D2> list = findBytodo(todo, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the h6d2s before and after the current h6d2 in the ordered set where todo = &#63;.
	 *
	 * @param h6d2Id the primary key of the current h6d2
	 * @param todo the todo
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public H6D2[] findBytodo_PrevAndNext(
			long h6d2Id, String todo, OrderByComparator<H6D2> orderByComparator)
		throws NoSuchH6D2Exception {
		...
		try {
			...
			array[0] = getBytodo_PrevAndNext(
				session, h6d2, todo, orderByComparator, true);

			array[1] = h6d2;

			array[2] = getBytodo_PrevAndNext(
				session, h6d2, todo, orderByComparator, false);
	...
	protected H6D2 getBytodo_PrevAndNext(
		Session session, H6D2 h6d2, String todo,
		OrderByComparator<H6D2> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the h6d2s where todo = &#63; from the database.
	 *
	 * @param todo the todo
	 */
	@Override
	public void removeBytodo(String todo) {
		for (H6D2 h6d2 :
				findBytodo(todo, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	/**
	 * Returns the number of h6d2s where todo = &#63;.
	 *
	 * @param todo the todo
	 * @return the number of matching h6d2s
	 */
	@Override
	public int countBytodo(String todo) {
		todo = Objects.toString(todo, "");

		FinderPath finderPath = _finderPathCountBytodo;

		Object[] finderArgs = new Object[] {todo};
	...
	private static final String _FINDER_COLUMN_TODO_TODO_2 = "h6d2.todo = ?";

	private static final String _FINDER_COLUMN_TODO_TODO_3 =
		"(h6d2.todo IS NULL OR h6d2.todo = '')";
	...
	public void activate(BundleContext bundleContext) {
		...
		_finderPathWithPaginationFindBytodo = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findBytodo",
			new String[] {
				String.class.getName(), Integer.class.getName(),
				Integer.class.getName(), OrderByComparator.class.getName()
			},
			new String[] {"todo"}, true);

		_finderPathWithoutPaginationFindBytodo = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findBytodo",
			new String[] {String.class.getName()}, new String[] {"todo"}, true);

		_finderPathCountBytodo = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBytodo",
			new String[] {String.class.getName()}, new String[] {"todo"},
			false);
	}
	...
	private static class H6D2ModelArgumentsResolver
		...
		static {
			...
			orderByColumnsBitmask |= H6D2ModelImpl.getColumnBitmask("todo");
