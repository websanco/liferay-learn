...
/**
 * Provides the base implementation for the h6d2 entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.acme.h6d2.service.impl.H6D2EntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.acme.h6d2.service.impl.H6D2EntryLocalServiceImpl
 * @generated
 */
public abstract class H6D2EntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, H6D2EntryLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>H6D2EntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>H6D2EntryLocalServiceUtil</code>.
	 */
	...
	public H6D2Entry addH6D2Entry(H6D2Entry h6d2Entry) {
		...
		return h6d2EntryPersistence.update(h6d2Entry);
	}
	...
	public H6D2Entry createH6D2Entry(long h6d2EntryId) {
		return h6d2EntryPersistence.create(h6d2EntryId);
	}
	...
	public H6D2Entry deleteH6D2Entry(long h6d2EntryId) throws PortalException {
		return h6d2EntryPersistence.remove(h6d2EntryId);
	}
	...
	public H6D2Entry deleteH6D2Entry(H6D2Entry h6d2Entry) {
		return h6d2EntryPersistence.remove(h6d2Entry);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return h6d2EntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			H6D2Entry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return h6d2EntryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return h6d2EntryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return h6d2EntryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return h6d2EntryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public H6D2Entry fetchH6D2Entry(long h6d2EntryId) {
		return h6d2EntryPersistence.fetchByPrimaryKey(h6d2EntryId);
	}
	...
	public H6D2Entry fetchH6D2EntryByUuidAndGroupId(String uuid, long groupId) {
		return h6d2EntryPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public H6D2Entry getH6D2Entry(long h6d2EntryId) throws PortalException {
		return h6d2EntryPersistence.findByPrimaryKey(h6d2EntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(h6d2EntryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(H6D2Entry.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("h6d2EntryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			h6d2EntryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(H6D2Entry.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<H6D2Entry>() {

				@Override
				public void performAction(H6D2Entry h6d2Entry)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, h6d2Entry);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return h6d2EntryPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return h6d2EntryLocalService.deleteH6D2Entry((H6D2Entry)persistedModel);
	}

	@Override
	public BasePersistence<H6D2Entry> getBasePersistence() {
		return h6d2EntryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return h6d2EntryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<H6D2Entry> getH6D2EntriesByUuidAndCompanyId(
		...
		return h6d2EntryPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<H6D2Entry> getH6D2EntriesByUuidAndCompanyId(
		...
		return h6d2EntryPersistence.findByUuid_C(
	...
	public H6D2Entry getH6D2EntryByUuidAndGroupId(String uuid, long groupId)
		...
		return h6d2EntryPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<H6D2Entry> getH6D2Entries(int start, int end) {
		return h6d2EntryPersistence.findAll(start, end);
	}
	...
	public int getH6D2EntriesCount() {
		return h6d2EntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			H6D2EntryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		h6d2EntryLocalService = (H6D2EntryLocalService)aopProxy;

		_setLocalServiceUtilService(h6d2EntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return H6D2EntryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = h6d2EntryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = H6D2EntryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, h6d2EntryLocalService);
		}
	...
	@Reference
	protected H6D2EntryPersistence h6d2EntryPersistence;
