...
/**
 * The arguments resolver class for retrieving value from H6D2Entry.
 *
...
@Component(
	immediate = true,
	service = {H6D2EntryModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class H6D2EntryModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		H6D2EntryModelImpl h6d2EntryModelImpl = (H6D2EntryModelImpl)baseModel;
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= h6d2EntryModelImpl.getColumnBitmask(
					columnName);
			}
	...
	private static Object[] _getValue(
		...
		for (int i = 0; i < arguments.length; i++) {
			...
			if (original) {
				...
				arguments[i] = h6d2EntryModelImpl.getColumnValue(columnName);
			}
		}
