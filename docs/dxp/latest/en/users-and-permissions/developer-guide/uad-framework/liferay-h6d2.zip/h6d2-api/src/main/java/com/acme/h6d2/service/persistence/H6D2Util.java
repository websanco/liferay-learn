...
public class H6D2Util {
	 ...
	 * @return the matching h6d2s
	 */
	public static List<H6D2> findBytodo(String todo) {
		return getPersistence().findBytodo(todo);
	}
	 ...
	 * @return the range of matching h6d2s
	 */
	public static List<H6D2> findBytodo(String todo, int start, int end) {
		return getPersistence().findBytodo(todo, start, end);
	}
	 ...
	 * @return the ordered range of matching h6d2s
	 */
	public static List<H6D2> findBytodo(
		String todo, int start, int end,
		OrderByComparator<H6D2> orderByComparator) {

		return getPersistence().findBytodo(todo, start, end, orderByComparator);
	}
	...
	public static List<H6D2> findBytodo(
		...
		return getPersistence().findBytodo(
			todo, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchH6D2Exception if a matching h6d2 could not be found
	 */
	public static H6D2 findBytodo_First(
			String todo, OrderByComparator<H6D2> orderByComparator)
		throws com.acme.h6d2.exception.NoSuchH6D2Exception {

		return getPersistence().findBytodo_First(todo, orderByComparator);
	}
	 ...
	 * @return the first matching h6d2, or <code>null</code> if a matching h6d2 could not be found
	 */
	public static H6D2 fetchBytodo_First(
		String todo, OrderByComparator<H6D2> orderByComparator) {

		return getPersistence().fetchBytodo_First(todo, orderByComparator);
	}
	 ...
	 * @throws NoSuchH6D2Exception if a matching h6d2 could not be found
	 */
	public static H6D2 findBytodo_Last(
			String todo, OrderByComparator<H6D2> orderByComparator)
		throws com.acme.h6d2.exception.NoSuchH6D2Exception {

		return getPersistence().findBytodo_Last(todo, orderByComparator);
	}
	 ...
	 * @return the last matching h6d2, or <code>null</code> if a matching h6d2 could not be found
	 */
	public static H6D2 fetchBytodo_Last(
		String todo, OrderByComparator<H6D2> orderByComparator) {

		return getPersistence().fetchBytodo_Last(todo, orderByComparator);
	}
	 ...
	 * @throws NoSuchH6D2Exception if a h6d2 with the primary key could not be found
	 */
	public static H6D2[] findBytodo_PrevAndNext(
			long h6d2Id, String todo, OrderByComparator<H6D2> orderByComparator)
		throws com.acme.h6d2.exception.NoSuchH6D2Exception {

		return getPersistence().findBytodo_PrevAndNext(
			h6d2Id, todo, orderByComparator);
	}
	 ...
	 * @param todo the todo
	 */
	public static void removeBytodo(String todo) {
		getPersistence().removeBytodo(todo);
	}
	 ...
	 * @return the number of matching h6d2s
	 */
	public static int countBytodo(String todo) {
		return getPersistence().countBytodo(todo);
	}
