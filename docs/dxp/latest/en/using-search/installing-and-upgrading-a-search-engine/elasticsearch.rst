...
.. toctree::
   ...
   elasticsearch/adding-settings-to-the-elasticsearch-connector.md
...
-  :doc:`/using-search/installing-and-upgrading-a-search-engine/elasticsearch/adding-settings-to-the-elasticsearch-connector`
