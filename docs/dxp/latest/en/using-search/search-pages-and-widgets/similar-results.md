...
| :---------------- | :----------|
| [Introduced in 7.4 U16] Scope | Choose between This Site (default) and Everything to display similar results from the current site only (*This Site*) or expand the scope of the search to all sites (*Everything*).
