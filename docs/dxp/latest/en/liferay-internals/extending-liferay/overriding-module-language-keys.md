...
```{important}
For Liferay DXP 7.4 U4 (Update 4) and above, the [Language Override tool](../../system-administration/configuring-liferay/changing-language-keys.md) is the recommended approach. If you're working with Liferay DXP/Portal 7.4+, please follow the instructions for [Overriding Global Language Keys](./overriding-global-language-keys.md).
```
