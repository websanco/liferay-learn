...
1. _追加ボタン_（![Add](../../../../images/icon-add.png)）をクリックします。 _新規ドキュメントタイプ_フォームが表示されます。
1. 名前を入力します。
1. 説明を入力します。
1. _［Main Metadata Fields］_セクションを展開します。
1. メタデータフィールドをエディターにドラッグアンドドロップします。

    ![メインのメタデータフィールドをドラッグアンドドロップする](./defining-document-types/images/10.png)

1. _［Additional Metadata Fields］_を展開します。
...
［Documents and Media］の_［Add］_メニューからドキュメントを追加するときに、新しいドキュメントタイプを使用できるようになりました。
