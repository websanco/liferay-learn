...
**アセットの自動タグ付け**: [自動タグ付け](../../content-authoring-and-management/tags-and-categories/auto_tagging.md)を有効または無効にします。
...
アセットライブラリのロールを作成またはカスタマイズするプロセスは、他の種類のロールの場合と同じです。 ロールを作成、カスタマイズ、管理、および割り当てる方法については、[Roles and Permissions](../../users-and-permissions/roles_and_permissions.html)を参照してください。
