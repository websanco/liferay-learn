...
*コントロールパネル* &rarr; *設定* &rarr; *サーバの管理*クリックしてサーバーの管理にアクセスすることができます 。
...
| :--- | :--- | :--- |
| 資源       | システムを監視し、管理タスクを実行します（ガベージコレクターの実行、データベースキャッシュのクリアなど）。                                                                                                                                                                                                                        | [システムリソースの管理](./using-the-server-administration-panel/managing-system-resources.md)                           |
...
| シャット ダウン | ログインしているユーザーにシャットダウンが迫っていることを警告するシャットダウンをスケジュールします（今から _x_ 分後）。                                                                                                                                                                                                              | [シャットダウンイベントの構成](./using-the-server-administration-panel/configuring-a-shutdown-event.md)                     |
