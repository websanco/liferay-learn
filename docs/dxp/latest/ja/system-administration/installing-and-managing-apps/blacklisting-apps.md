...
```{important}
ブラックリストは、DXPがアプリのアンインストールに使用する [OSGi設定](https://help.liferay.com/hc/en-us/articles/360029131591-System-Settings#exporting-and-importing-configurations) です。 これを使用すると、リストされているアプリは削除されるまでインストールされなくなります。
```
