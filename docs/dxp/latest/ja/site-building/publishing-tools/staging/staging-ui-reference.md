...
![サイトのステージングが有効になっている場合、サイトの各ページのステージングバーにアクセスできます。](./staging-ui-reference/images/02.png)
...
![[本番環境に公開]をクリックして、公開モーダルウィンドウにアクセスします。](./staging-ui-reference/images/03.png)
...
![[本番環境に公開]をクリックして、公開を開始します。](./staging-ui-reference/images/04.png)
...
![詳細設定を使用して、公開プロセスをカスタマイズします。](./staging-ui-reference/images/05.png)
...
![変更をいつ公開するかを選択します。](./staging-ui-reference/images/06.png)

**Deletions**：*インポートする前にアプリケーションデータを削除する*かどうか、および*個々の削除を複製する*かどうかを選択します。

![インポートする前にアプリケーションデータを削除するかどうか、および個々の削除を複製するかどうかを選択します。](./staging-ui-reference/images/07.png)
...
![公開するページセットのバリエーションと個々のページ、および選択したページのルックアンドフィールを選択します。](./staging-ui-reference/images/08.png)
...
![公開プロセスに含めるコンテンツを選択します。](./staging-ui-reference/images/09.png)

**権限設定**：変更が公開されたときにページとウィジェットの権限を含めるかどうかを選択します。

![変更が公開されたときにページとウィジェットの権限を含めるかどうかを選択します。](./staging-ui-reference/images/10.png)
...
![公開プロセス用に保存されたテンプレートを表示および選択するには、[公開テンプレート]タブをクリックします。](./staging-ui-reference/images/11.png)
...
![ステージングページで新しいオプションにアクセスすることもできます。](./staging-ui-reference/images/13.png)
...
![ステージングページから以前の公開プロセスを表示および管理します。](./staging-ui-reference/images/14.png)
...
![ステージングページのアプリケーションバーにあるアクションボタンをクリックします。](./staging-ui-reference/images/15.png)

ここから、頻繁に公開する設定のテンプレートを作成および管理できます。 次に、*アクション*ボタン（![Actions button](../../../images/icon-actions.png)）をクリックして*[公開]* を選択すると、テンプレートを使用できます。

![頻繁に公開する設定のテンプレートを作成および管理します。](./staging-ui-reference/images/16.png)
...
![ステージングページのアプリケーションバーにあるアクションボタンをクリックして、ステージング設定にアクセスします。](./staging-ui-reference/images/17.png)
