...
| :--- | :--- | :--- | :--- |
| **有効** | `enabled`                   | CAS SSO認証を有効にするには、このボックスをオンにします。                                                                                                                                                                    | `ブール値`    |
...
| **Logout on session expiration** | `logoutOnSessionExpiration` | オンにすると、セッションが期限切れのブラウザがCASログアウトURLにリダイレクトされます。                                                                                                                                                      | `ブール値`    |
