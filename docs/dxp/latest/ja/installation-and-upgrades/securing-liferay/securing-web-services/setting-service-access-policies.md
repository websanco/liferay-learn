...
1. _［Allowed Service Signatures］_で、インストールされているサービスクラスの完全修飾名を入力します。
...
1. _［コントロールパネル］_ &rarr; _［システム設定］_ &rarr; _［API 認証］_に移動します。

    ![サービスアクセスポリシーモジュールの場所](./setting-service-access-policies/images/02.png)

1. ［Security］セクションの_［Service Access Policies］_ モジュールをクリックします。 名前をクリックして編集します。
