...
If you need to delete an Image Resolution, you must first disable it because you _cannot_ delete enabled resolutions. This prevents the accidental deletion of image resolutions.
