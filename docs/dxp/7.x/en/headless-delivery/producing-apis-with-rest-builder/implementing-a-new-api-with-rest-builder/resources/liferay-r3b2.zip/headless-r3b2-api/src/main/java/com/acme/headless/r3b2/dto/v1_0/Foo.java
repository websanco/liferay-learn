package com.acme.headless.r3b2.dto.v1_0;
...
public class Foo implements Serializable {
	...
	@Schema(description = "Say something about your Foo.")
	...
	@GraphQLField(description = "Say something about your Foo.")
	...
	@GraphQLField(description = "The title of your Foo.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	...
	@Schema(
		defaultValue = "com.acme.headless.r3b2.dto.v1_0.Foo",
		name = "x-class-name"
	)
