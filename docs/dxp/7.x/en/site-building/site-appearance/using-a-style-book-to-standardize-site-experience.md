...
If you do not choose a specific Style Book for a page, the page uses the Style Book for the Master Page. If neither are set, the page uses the default Style Book for the Site. 
