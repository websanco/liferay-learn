...
Here's the `determine-branch` condition from the [Category Specific Approval](../designing-and-managing-workflows/workflow-designer/workflow-designer-overview/resources/category-specific-definition.xml) workflow definition:
