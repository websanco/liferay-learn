# Module 8: Customize the User Interface
...
Understand the basics of Liferay user interface architecture and learn how to approach portal user interface customization.

<h4>Tasks to Accomplish</h4>
<ul>
    <li>Create a widget template to be used for a media gallery</li>
    <li>Create a Liferay Module Project fragment and implement a JSP.</li>
