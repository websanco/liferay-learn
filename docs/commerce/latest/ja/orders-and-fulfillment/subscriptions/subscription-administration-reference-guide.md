...
サブスクリプションは _グローバルアプリケーション_ の _サブスクリプション_ メニューで[管理](./managing-subscriptions.md)されています。 この記事では、 _サブスクリプション_ メニューで使用できるさまざまな機能とフィールドについて説明します。
...
サブスクリプションは _コントロールパネル_ の _サブスクリプションメニュー_ で[管理](./managing-subscriptions.md)されています。
