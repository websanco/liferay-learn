...
1. _3ドット_ アイコン（![Actions icon](../../../images/icon-actions.png)）をクリックし、次に _6_ 横にある _編集_ をクリックします。 （この時点で、［_詳細_］メニューでSKUの名前を _「6パック」_ などのよりわかりやすい名前に変更できます。）
1. 次のように入力します：
    * **Price**: 19.99
    * **Promo Price**: 0.00
    * **Cost**: 0.00
...
1. _3ドット_ アイコンをクリックして、［_6_］の隣にある［_編集_］をクリックします。 （この時点で、［_詳細_］メニューでSKUの名前を _「6パック」_ などのよりわかりやすい名前に変更できます。）
